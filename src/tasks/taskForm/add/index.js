            ...
            <ProjectSelectModal
                ...
                projects={
                    loading
                        ? []
                        : toSelArr(
                              projectsData.myProjects.map(
                                  (myProject) => ({
                                      ...myProject.project,
                                      right: myProject.right,
                                      attributeRights:
                                          myProject.attributeRights,
                                      users: myProject.usersWithRights.map(
                                          (
                                              userWithRights
                                          ) =>
                                              userWithRights
            ...
            projects={
                loading
                    ...
                    : toSelArr(
                          ...
                          (project) => project.right.addTask
                      )
            }
            myProjects={
                loading ? [] : projectsData.myProjects
            }
            users={
                usersData
                    ? toSelArr(

...
export default function TaskList(props) {
    const { navigation, markedDate, showCalendar, search } =
        props;
    ...
    return (
        <ScrollView height={showCalendar ? '55%' : '100%'}>
            ...
            {tasksData && tasksData.tasks.count > limit && (
                <Button
                    shadow={2}
                    onPress={() => {
                        setLimit(limit + 10);

...
export default function CalendarView ( props ) {
  ...
  return (
    <View>
      {
        showSearch &&
        <Flex direction="row" justify="space-between" bgColor="#0078d4" p="2">
          <IconButton
          ...
          />
            ...
            />
          <IconButton
            onPress={() => setActualSearch(search)}
            variant="ghost"
            _icon={{
              as: FontAwesome,
              name: "check-circle",
    ...
    <List
      ...
      markedDate={Object.keys(markedDates).length === 0 ? null : markedDates[Object.keys(markedDates)].unix}
      search={actualSearch}
       />
